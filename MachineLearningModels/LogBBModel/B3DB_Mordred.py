...
# 设置日志记录器
log = DataLogger(log_file=f"../../data/b3db_data/log/{datetime.now().strftime('%Y%m%d')}.log").getlog("ratio_xgboost_training")


# 文件路径设置
b3db_file = "../../data/B3DB_classification.tsv"
desc_file = '../../data/B3DB_w_desc.csv'
desc_index_file = "../../data/logBB_data/desc_index.txt"
