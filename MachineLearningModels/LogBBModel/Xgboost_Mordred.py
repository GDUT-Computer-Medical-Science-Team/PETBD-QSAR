...
if __name__ == '__main__':
    ...
    log.info("===============StartingXGBoost[Chinese text removed]===============")
    # [Chinese text removed]
    ...
    # [Chinese text removed] - [Chinese text removed]scaler
    sc = MinMaxScaler()
    ...
    def objective(trial):
        ...
        params = {
            ...
            'random_state': seed,
            'objective': 'reg:squarederror'  # [Chinese text removed]
        }
        ...
        model.fit(X_train, y_train,
                 ...
                 verbose=False)  # XGBoost [Chinese text removed] verbose parameter
    ...
    rmse_result_list = []
    r2_result_list = []
    mse_result_list = []  # [Chinese text removed]
    mae_result_list = []  # [Chinese text removed]
    adj_r2_result_list = []  # [Chinese text removed]
    ...
    # TODO: B3DB[Chinese text removed]
    ...
    log.info("[Chinese text removed] './result/xgb_mordred_scatter.png'")